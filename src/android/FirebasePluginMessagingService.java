...
public class FirebasePluginMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.i("message","notification received called");
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            title = remoteMessage.getData().get("target");
        ...
        Log.i("message","notification receiced called  "+id+" "+title+" "+text);

        try {
           AppMobiCloudPushListener.sharedListener.showTrayNotification(AppMobiCloudController.sharedController.activity, text,
